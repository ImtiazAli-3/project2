...
<div class="wrappermain">
    ...
    <br>    
        <h1 class="titlesignup"><u>Sign up</u></h1>
    <?php
      if (isset($_GET['error'])) {
          if ($_GET['error'] == 'emptyfields') {
              echo '<div class="errormessage">Fill in all fields</div>';
          }
          if ($_GET['error'] == 'invalidmail') {
              echo '<div class="errormessage">Invalid username and email</div>';
          }
          ...
          if ($_GET['error'] == 'invalidmailuid') {
              echo '<div class="errormessage">Invalid</div>';
          }
          if ($_GET['error'] == 'passwordcheck') {
              echo '<div class="errormessage">Your passwords do not match</div>';
          }           
          if ($_GET['error'] == 'usertaken') {
              echo '<div class="errormessage">That user is already taken</div>';
          } 
      }  
        ?>    
        <form action="signup2.php" method="post" id="signupform">
        <input type="text" id="usr" name="uid" placeholder="Username">
        <input type="text" id="mail" name="mail" placeholder="Email">
        <input type="password" id="pwd" name="pwd" placeholder="Password">
        <input type="password" id="pwdr" name="pwdrepeat" placeholder="Repeat Password">
        <button type="submit" id="signupbtn1"name="signup-submit">Signup</button>    
        </form>
    </section>
    </div>
    <style>
        ...
        #pwdr:focus,#pwd:focus,#mail:focus,#usr:focus{
