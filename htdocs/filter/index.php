...
function topFunction() {
  document.documentElement.scrollTop = 0;
    ...
    <div class="container">
        <div class="row">
        	<br />
        	<h2 align="center">Browse our entire store right here!</h2>
        	<br />
            <div class="col-xl-3 col-lg-3 col-sm-5 col-xs-12">                				
				...
				<div class="list-group" style="background:#fff;box-shadow: 0px 1px 5px rgba(0, 0, 0, .5);">
                    ...
                    $query = "
                    SELECT DISTINCT(p_cat_title) FROM products WHERE product_status = '1' ORDER BY p_cat_title DESC
                    ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    ...
                    ?>
                    <div class="list-group-item checkbox"><label>
                        <input type="checkbox" class="common_selector pcat" value="<?php echo $row['p_cat_title']; ?>" > <?php echo $row['p_cat_title']; ?> </label>
                    </div>
                    <?php    
                    }
...
$(document).ready(function(){
    ...
    function filter_data()
    {
        ...
        var pcat = get_filter('pcat');
        var cat = get_filter('cat');
        $.ajax({
            url:"fetch_data.php",
            method:"POST",
            data:{action:action, minimum_price:minimum_price, maximum_price:maximum_price, man:man, pcat:pcat, cat:cat},
