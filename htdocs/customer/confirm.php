...
<body>
   ...
   <div id="top"><!-- Top Begin -->
       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="col-xl-6 offer"><!-- col-xl-6 offer Begin -->
           ...
           </div><!-- col-xl-6 offer Finish -->
           
           <div class="col-xl-6"><!-- col-xl-6 Begin -->
   ...
   <div id="content"><!-- #content Begin -->
       <div class="container"><!-- container Begin -->
           ...
           <div class="col-xl-3"><!-- col-xl-3 Begin -->
   ...
   <?php 
    ...
    ?>
           ...
           <div class="col-xl-9"><!-- col-xl-9 Begin -->
