<div class="box" style="margin-top: 30px;margin-bottom:100px;"><!-- box Begin -->
  ...
  <div class="box-header"><!-- box-header Begin -->
      ...
      <center><!-- center Begin -->
          ...
          <p class="text-muted"> Manage and track all your orders with our extremely easy account system</p>
